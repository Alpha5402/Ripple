...
<template>
  <Welcome v-if="!state?.documents.length" :can-open="!!bridge.chooseFolder" :browser-local="!bridge.chooseEmbedding && !!bridge.chooseFolder" :error="error" @open="chooseFolder"/>
