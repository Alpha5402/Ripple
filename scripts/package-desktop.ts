...
const paths = await packager({ dir: 'dist/desktop', out: 'release/current', name: 'Ripple', icon: 'dist/Ripple.icns', electronVersion, appBundleId: 'dev.alpha.ripple', platform: 'darwin', arch: 'arm64', overwrite: true, asar: { unpack: '**/wemm/**' }, prune: false, appCategoryType: 'public.app-category.productivity', extendInfo: { NSHumanReadableCopyright: 'Ripple • Alpha', NSHighResolutionCapable: true } });
